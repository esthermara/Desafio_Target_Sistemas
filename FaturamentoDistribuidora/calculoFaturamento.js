//Array de exemplo de fonte de dados do fatuaramento mensal (dados.json)
...
function mediaMensal(faturamento) {
    ...
    const soma = diasComFaturamento.reduce((total, item) => total + item.valor, 0);
...
console.log("Menor faturamento diário:", menorFaturamento(faturamentoMensal));
console.log("Maior faturamento diário:", maiorFaturamento(faturamentoMensal));
console.log("Número de dias com faturamento acima da média:", diasAcimaMedia(faturamentoMensal));
